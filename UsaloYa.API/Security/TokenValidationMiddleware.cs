    ...
    public class TokenValidationMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            if (context.Request.Path.StartsWithSegments("/api/User/RegisterNewUser", StringComparison.OrdinalIgnoreCase) ||
                ...
                context.Request.Path.StartsWithSegments("/api/Pregunta/GetPreguntas", StringComparison.OrdinalIgnoreCase) ||
                context.Request.Path.StartsWithSegments("/api/Pregunta/SavePreguntas", StringComparison.OrdinalIgnoreCase) ||
