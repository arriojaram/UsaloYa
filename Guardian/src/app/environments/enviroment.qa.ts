...
{
    production: false,
    apiUrlBase: 'https://api.test.usaloya.xyz',
    ...
    PAIRSETT_ACTIVAR_IMPRESORA_MOBILE: "activarImpresionMobile",
    PAIRSETT_ACTIVAR_IMPRESORA_WEB: "activarImpresionWeb",
    ...
    whatsNumber: 'https://api.whatsapp.com/send?phone=2225725212'
}